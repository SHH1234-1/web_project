...
<html lang="ko">
  ...
  <body style="width: 1200px; margin: 0 auto;">
    ...
    <header>
     ...
     <main>
         <div class="client_control_heander"> 
            <img src="images/icons8-easy-30.png" class="img-thumbnail" alt="이미지를 추가해 주세요"> <span id="title_size">회원관리</span>
        </div>
  ...
  <script src="js/button_control2.js"></script>
